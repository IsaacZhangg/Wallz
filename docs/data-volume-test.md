...
positions per round is data-starved. The dedicated generation node exists to
...
positions generated by the kata recipe _after_ round 31 (chunk 82 onward),
...
fresh-data _rate_ under a fixed 60K window," not data volume in the
